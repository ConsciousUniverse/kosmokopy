...
- **Auto-rename on conflict** — when Rename mode is selected, conflicting files are saved as `file_1.ext`, `file_2.ext`, etc.; works for both local and remote destinations
